...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description: 'a reusable section can be made up of one or more content sections, the same ones used on pages',
      validation: Rule => Rule.error('Add at least one content section.').required(),
      type: 'array',
      of: [
        {type: 'magSection'},
        {type: 'ctaSection'},
