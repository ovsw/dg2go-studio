...
export default {
  ...
  fields: [
    ...
    },
    {
      ...
      description: 'this option makes the meal not show up on the meals menu page for customers. It will still be shown on the hidden page accessible to the DG2GO staff only. Used for placing late orders on meals.',
      type: 'boolean'
    }
  ],
  orderings: [
