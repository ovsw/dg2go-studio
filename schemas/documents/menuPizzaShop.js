      ...
      fields: [
        {
          ...
          description: 'this content appears on the page before the pizza shop menus',
          type: 'array',
          of: [
            {type: 'magSection'},
            {type: 'ctaSection'},
        ...
        },
        {
          ...
          type: 'bgImage',
          validation: Rule => Rule.required().error('Original Pizza image missing')
        },
        {
          fieldset: 'main',
        ...
        },
        {
          ...
          type: 'bgImage',
          validation: Rule => Rule.required().error('Deep Dish Pizza image missing')
        },
        {
          fieldset: 'main',
        ...
        },
        {
          ...
          type: 'bgImage',
          validation: Rule => Rule.required().error('Junior Hoagies image missing')
        },
        {
          fieldset: 'main',
